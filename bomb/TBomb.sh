...
banner() {
    ...
    if ! [ -x "$(command -v toilet)" ]; then
        echo -e "\e[4;34m This Bomber Was Created By \e[1;GD \e[0m"
    else
        echo -e "\e[1;34mCreated By \e[1;GD"
        toilet -f mono12 -F border SpeedX
    fi
    echo -e "\e[1;34m For Any Queries Join Me!!!\e[0m"
    echo -e "\e[1;32m           Telegram: https://t.me/GD03Champ \e[0m"
    echo -e "\e[4;32m   Web:gdindustries.xyz \e[0m"
    echo " "
...
if [ -f .update ];then
    ...
    echo .
    install_deps
    echo This Script Was Made By GD > .update
