...
def check_intr():
    try:
        requests.get("https://gdindustries.xyz")
    except Exception:
        bann_text()
...
def do_zip_update():
    ...
    if success:
        ...
        mesgdcrt.WarningMessage(
            "Grab The Latest one From https://t.me/GD03Champ")
...
def do_git_update():
    ...
    if success:
        ...
        print(
            "git checkout . && "
            "git pull https://github.com/gd2003gamingchamp/TBomb.git HEAD")
    sys.exit()
...
def check_for_updates():
    ...
    fver = requests.get(
            "https://raw.githubusercontent.com/gd2003gamingchamp/TBomb/master/.version"
            ).text.strip()
    if fver != __VERSION__:
...
def notifyen():
    try:
        noti = requests.get(
            "https://raw.githubusercontent.com/gd2003gamingchamp/TBomb/master/.notify"
            ).text.upper()
        if len(noti) > 10:
...
def pretty_print(cc, target, success, failed):
    ...
    mesgdcrt.SuccessMessage("TBomb was created by GD")
